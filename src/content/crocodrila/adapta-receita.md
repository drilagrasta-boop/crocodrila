...
O prompt faz quatro coisas que a conta simples não faz.
...
forno, tamanho de panela e ponto de sal, não. Fermento, gelatina e liga escalam com
ressalva declarada. Arredondamento só quando a diferença some no prato, e sempre avisado.
...
2. Calcular o fator de escala a partir do alvo. Se o alvo for um
   ingrediente-âncora (ex.: "três morcillas" numa receita de duas),
   o fator sai dele: 3 ÷ 2 = 1,5.

3. Aplicar o fator a todos os ingredientes. Arredondar só quando a diferença
...
4. Entregar no widget de receita, com:
   - porções ajustadas
...
5. Encerrar com uma linha em prosa dizendo o que mudou. Sem lista repetindo
...
escreveu porque quem cozinhava já tinha no corpo.
