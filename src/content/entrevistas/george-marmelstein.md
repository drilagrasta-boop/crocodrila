...
<!-- ============================================================
     RASCUNHO. Não publicar enquanto rascunho: true no topo.
     Quando o George responder: cole cada resposta no lugar do
     placeholder _(resposta)_ e apague o comentário <!-- âncora -->
     de cada pergunta. Título, resumo e papel são provisórios —
     ajuste para uma frase boa que ele tenha dito na conversa real.
...
<!-- âncora: a origem do "superaprendiz", a raiz de tudo que veio depois. -->

_(resposta)_

**_Superaprendizagem_ saiu em 2023 e você o chama de "caixa de ferramentas para uma vida intelectualmente produtiva". Quando a IA generativa explodiu logo em seguida, ela validou ou bagunçou o que você tinha acabado de escrever?**

<!-- âncora: o livro x a chegada do ChatGPT no mesmo ano. Tensão boa. -->
...
**Você reformula "alucinação" como falta de conhecimento do humano sobre usar a IA, não defeito da máquina. Não há um risco aí de tirar responsabilidade de quem fabrica a ferramenta e jogar tudo no colo de quem usa?**

<!-- âncora: a tese das alucinações. Contraponto respeitoso — entrevista boa tem atrito. -->

_(resposta)_

**"Prótese cognitiva", "asas para o pensamento", "não use como muleta". A distância entre asa e muleta é fina. Na prática, como um aluno ou um juiz sabe de que lado da linha ele está?**

<!-- âncora: as metáforas dele. Força ele a operacionalizar o que soa bonito. -->

_(resposta)_

**Você integrou o grupo de trabalho do CNJ que revisou a norma de IA no Judiciário e hoje coordena o GT de IA do TRF5, encarregado de fazer a Resolução 615 sair do papel. O que é mais difícil: convencer um juiz a usar IA, ou convencê-lo a usar dentro de um limite?**

<!-- âncora: Portaria CNJ 338/2023 e a coordenação do GT-IA do TRF5 (Portaria Conjunta 2/2025). -->

_(resposta)_

**A 615 entrou em vigor em julho de 2025 com uma lista de usos proibidos. Olhando pra dentro dos tribunais hoje, a régua que vocês desenharam está sendo respeitada — ou já nasceu sendo contornada?**

<!-- âncora: vigência da Resolução 615/2025. Puxa realidade, não teoria. -->

_(resposta)_

**Você ensina a controlar a IA com a tríade Útil, Honesto, Inofensivo e com o seu método POEMA — Persona, Objetivo, Estilo, Método, Adicionais. Dá pra ensinar ética de uso por framework, ou tem uma parte que só a régua interna de cada um resolve?**

<!-- âncora: HHH (da Anthropic) e o POEMA, criação dele. -->

_(resposta)_

**Boa parte de quem aprendeu a trabalhar com IA no Direito brasileiro saiu de prompt que você publicou de graça. Por que entregar aberto o que muita gente teria trancado num curso pago?**

<!-- âncora: a generosidade — os prompts públicos. -->

_(resposta)_

**Vou te confessar uma coisa: a Crocodrila, a toca de projetos que mantenho, nasceu dos seus prompts. Conversor de PDF, anonimizador — tudo creditado a você. O que te dá mais orgulho: o aluno que reproduz o seu método, ou o que pega e faz virar outra coisa?**

<!-- âncora: o crédito "Inspirado no Sistema Marmelstein". Fecha o laço professor–aluna. -->
