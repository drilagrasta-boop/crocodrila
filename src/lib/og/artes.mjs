...
export const POSES = {
  ...
  microfone: wrap(`<g transform="translate(0 8)"><rect x="86" y="4" width="16" height="26" rx="8" fill="#c49a3a" stroke="#1d2b24" stroke-width="1.2"/><path d="M80,20 a14,14 0 0 0 28,0" fill="none" stroke="#3c5a45" stroke-width="2.4" stroke-linecap="round"/><line x1="94" y1="34" x2="94" y2="38" stroke="#3c5a45" stroke-width="2.4" stroke-linecap="round"/><g stroke="#c49a3a" stroke-width="1.8" fill="none" stroke-linecap="round" opacity="0.75"><path d="M114,10 q6,7 0,14"/><path d="M121,6 q10,11 0,22"/><path d="M128,2 q14,15 0,30"/></g></g>`),
